...
def export(request):
    ...
    if request.method == 'POST':
        ...
        if form['export_ke_Excel'].value() == True:
            ...
            rows = queryset.values_list('nis', 'nisn', 'nik', 'no_kk', 'nama', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin__jenis', 'agama__agama', 'alamat', 'kecamatan', 'kabupaten', 'propinsi', 'hobi__hobi', 'cita_cita__cita', 'anak_ke', 'jumlah_saudara', 'tanggal_masuk_pesantren', 'status_asal_santri__status_asal_santri', 'sekolah_asal', 'alamat_sekolah_asal',
                        'wilayah__nama', 'lembaga__nama', 'diniyah__nama', 'tahun_pelajaran__tahun_pelajaran', 
                        'nama_ayah', 'status_hidup_ayah', 'pendidikan_ayah__pendidikan_ayah', 'pekerjaan_ayah', 'no_hp_ayah',
                        'nama_ibu', 'status_hidup_ibu', 'pendidikan_ibu__pendidikan_ibu', 'pekerjaan_ibu', 'no_hp_ibu',
                        'nama_wali', 'pendidikan_wali__pendidikan_wali', 'pekerjaan_wali', 'no_hp_wali', 'penghasilan_orang_tua_atau_wali_perbulan__penghasilan' )
            for row in rows:
                row_num += 1
...
def export_santridiniyah(request):
    ...
    if request.method == 'POST':
        ...
        if form['export_ke_Excel'].value() == True:
            ...
            rows = queryset.filter(diniyah=request.user.diniyah).values_list('nis', 'nisn', 'nik', 'no_kk', 'nama', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin__jenis', 'agama__agama', 'alamat', 'kecamatan', 'kabupaten', 'propinsi', 'hobi__hobi', 'cita_cita__cita', 'anak_ke', 'jumlah_saudara', 'tanggal_masuk_pesantren', 'status_asal_santri__status_asal_santri', 'sekolah_asal', 'alamat_sekolah_asal',
                        'wilayah__nama', 'lembaga__nama', 'diniyah__nama', 'tahun_pelajaran__tahun_pelajaran', 
                        'nama_ayah', 'status_hidup_ayah', 'pendidikan_ayah__pendidikan_ayah', 'pekerjaan_ayah', 'no_hp_ayah',
                        'nama_ibu', 'status_hidup_ibu', 'pendidikan_ibu__pendidikan_ibu', 'pekerjaan_ibu', 'no_hp_ibu',
                        'nama_wali', 'pendidikan_wali__pendidikan_wali', 'pekerjaan_wali', 'no_hp_wali', 'penghasilan_orang_tua_atau_wali_perbulan__penghasilan' )
...
def export_santrilembaga(request):
    ...
    if request.method == 'POST':
        ...
        if form['export_ke_Excel'].value() == True:
            ...
            rows = queryset.filter(lembaga=request.user.lembaga).values_list('nis', 'nisn', 'nik', 'no_kk', 'nama', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin__jenis', 'agama__agama', 'alamat', 'kecamatan', 'kabupaten', 'propinsi', 'hobi__hobi', 'cita_cita__cita', 'anak_ke', 'jumlah_saudara', 'tanggal_masuk_pesantren', 'status_asal_santri__status_asal_santri', 'sekolah_asal', 'alamat_sekolah_asal',
                        'wilayah__nama', 'lembaga__nama', 'diniyah__nama', 'tahun_pelajaran__tahun_pelajaran', 
                        'nama_ayah', 'status_hidup_ayah', 'pendidikan_ayah__pendidikan_ayah', 'pekerjaan_ayah', 'no_hp_ayah',
                        'nama_ibu', 'status_hidup_ibu', 'pendidikan_ibu__pendidikan_ibu', 'pekerjaan_ibu', 'no_hp_ibu',
                        'nama_wali', 'pendidikan_wali__pendidikan_wali', 'pekerjaan_wali', 'no_hp_wali', 'penghasilan_orang_tua_atau_wali_perbulan__penghasilan' )
...
def export_santriwilayah(request):
    ...
    if request.method == 'POST':
        ...
        if form['export_ke_Excel'].value() == True:
            ...
            rows = queryset.filter(wilayah=request.user.wilayah).values_list('nis', 'nisn', 'nik', 'no_kk', 'nama', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin__jenis', 'agama__agama', 'alamat', 'kecamatan', 'kabupaten', 'propinsi', 'hobi__hobi', 'cita_cita__cita', 'anak_ke', 'jumlah_saudara', 'tanggal_masuk_pesantren', 'status_asal_santri__status_asal_santri', 'sekolah_asal', 'alamat_sekolah_asal',
                        'wilayah__nama', 'lembaga__nama', 'diniyah__nama', 'tahun_pelajaran__tahun_pelajaran', 
                        'nama_ayah', 'status_hidup_ayah', 'pendidikan_ayah__pendidikan_ayah', 'pekerjaan_ayah', 'no_hp_ayah',
                        'nama_ibu', 'status_hidup_ibu', 'pendidikan_ibu__pendidikan_ibu', 'pekerjaan_ibu', 'no_hp_ibu',
                        'nama_wali', 'pendidikan_wali__pendidikan_wali', 'pekerjaan_wali', 'no_hp_wali', 'penghasilan_orang_tua_atau_wali_perbulan__penghasilan' )

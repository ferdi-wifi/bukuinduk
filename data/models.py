...
class Statusasalsantri(models.Model):
    ...
    def __str__(self):
        ...
        # return '%s, %s' % (self.id, self.status_asal_santri)
...
class Statushidupibu(models.Model):
    ...
    def __str__(self):
        ...
        # return '%s, %s' % (self.id, self.status_hidup_ibu)
...
class Statushidupayah(models.Model):
    ...
    def __str__(self):
        ...
        # return '%s, %s' % (self.id, self.status_hidup_ayah)
...
class Pendidikanayah(models.Model):
    ...
    def __str__(self):
        ...
        # return '%s, %s' % (self.id, self.pendidikan_ayah)
...
class Pendidikanibu(models.Model):
    ...
    def __str__(self):
        ...
        # return '%s, %s' % (self.id, self.pendidikan_ibu)
...
class Pendidikanwali(models.Model):
    ...
    def __str__(self):
        ...
        # return '%s, %s' % (self.id, self.pendidikan_wali)
